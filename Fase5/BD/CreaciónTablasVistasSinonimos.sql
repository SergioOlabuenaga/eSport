...
DROP PUBLIC SYNONYM EQUIPOS;
DROP PUBLIC SYNONYM JUGADORES;
DROP PUBLIC SYNONYM DUENOS;
DROP PUBLIC SYNONYM ASISTENTES;
DROP PUBLIC SYNONYM JORNADAS;
DROP PUBLIC SYNONYM CLAS;
DROP PUBLIC SYNONYM PARTIDOS;
DROP PUBLIC SYNONYM ENTRENADORES;
...
CREATE OR REPLACE PUBLIC SYNONYM DUENOS FOR EQDAW04.DUENO;
